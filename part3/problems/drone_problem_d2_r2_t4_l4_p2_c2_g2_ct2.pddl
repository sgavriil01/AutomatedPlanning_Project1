(define (problem drone_problem_d2_r2_t4_l4_p2_c2_g2_ct2)
...
(:init
	...
	(= (fly-cost depot loc1) 164)
	(= (fly-cost depot loc2) 244)
	(= (fly-cost depot loc3) 95)
	(= (fly-cost depot loc4) 120)
	(= (fly-cost loc1 depot) 164)
