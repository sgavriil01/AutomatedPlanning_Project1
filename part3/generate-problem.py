...
def main():
    ...
    parser.add_option('-t', '--capacity', metavar='NUM', type=int, dest='capacity',
                      help='the maximum number of crates a carrier can hold')
    ...
    with open(output_file, 'w') as f:
        ...
        # Generate num tokens N0..N<capacity> based on -t flag
        num_tokens = ["N" + str(i) for i in range(options.capacity + 1)]
        f.write("\t" + " ".join(num_tokens) + " - num\n")
        ...
        # Minimize makespan (total-time) for temporal planning
