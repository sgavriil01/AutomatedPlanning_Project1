(define (problem project1_problem_test)
    ...
    (:init
        ...
        (load carrier1 N4)  ; this to test bypass planner only picking up crates from the ground

        ; All crates in carrier 1 (test to bypass planner only picking up crates from the ground)
        (in crate1 carrier1)
        (in crate2 carrier1)
        (in crate3 carrier1)
        (in crate4 carrier1)
